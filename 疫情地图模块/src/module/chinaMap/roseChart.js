...
//     };
 ...
 sourceData = [
//  {'name': '澳门特别行政区', 'value': 30, 'extData': [1, '#C9DA36', 0, '']},
//  {'name': '西藏自治区', 'value': 33, 'extData': [1, '#CF7B25', 0, '']},
//  {'name': '青海省', 'value': 38, 'extData': [2, '#cff169', 0, '']},
//  {'name': '宁夏回族自治区', 'value': 40, 'extData': [3, '#cfee69', 0, '']},
//  {'name': '香港特别行政区', 'value': 40, 'extData': [4, '#d0ed6a', 0, '']},
//  {'name': '海南省', 'value': 41, 'extData': [5, '#d0eb6a', 0, '']},
//  {'name': '天津市', 'value': 51, 'extData': [6, '#d3db6d', 0, '']},
//  {'name': '新疆维吾尔自治区', 'value': 53, 'extData': [7, '#d4d76e', 0, '']},
    ...
    render(){
        return(
            ...
            <View style={styles.container}>
                {/* <View >
                <Text style={styles.textback}>aaa</Text>
                </View> */}
