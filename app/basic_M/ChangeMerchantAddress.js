...
var ip=require('./ip')
export default class ChangeMerchantAddress extends React.Component {
  ...
  change = () => {
        ...
        .then((res) => { //alert(JSON.stringify(res.data));
            if(res.data.result=='Y'){
               alert('修改成功!')
               //this.props.navigation.navigate('ProfileMerchant',{ username:this.state.username,adress:this.state.adress } );
