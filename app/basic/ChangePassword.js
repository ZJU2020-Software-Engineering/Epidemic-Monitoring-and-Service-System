  ...
  constructor(props){
    ...
    checkpassword = ()=>{ 
        ...
        if(this.state.newpassword<=0){
          ...
          axios.post(ip+'/request/info/personalUserInfo/checkPassword',data, {headers:token}) 
                 ...
                 if(res.data.result=='N'){
                  ...
                  alert(res.data.message)
                    ...
                    navigate('Home');
                        ...
                        axios.post(ip+'/request/info/personalUserInfo/changePassword',data, {headers:token}) 
                        .then((res) => { //alert(JSON.stringify(res.data));
                          if(res.data.result=='N'){
                            alert(res.data.message)
                          }
