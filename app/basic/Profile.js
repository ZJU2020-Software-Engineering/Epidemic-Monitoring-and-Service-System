    ...
    return (
           ...
           <View>
              ...
              <ListItem
                    ...
                    ViewComponent={LinearGradient} // Only if no expo
                    leftIcon={{ type: 'font-awesome', name: 'thumbs-up', color: 'white' }}
                    title=" 每日打卡"
                    titleStyle={{ color: 'white', fontWeight: 'bold' }}
                    rightIcon={{ type: 'font-awesome', name: 'chevron-right', color: 'white', size: '20' }}
                    onPress={() => this.props.navigation.navigate('DailyReportScreen', { username: this.state.username, token: this.state.token, })}
                />
                <ListItem
                    Component={TouchableScale}
                    friction={90}
                    ...
                    ViewComponent={LinearGradient} // Only if no expo
                    leftIcon={{ type: 'font-awesome', name: 'qrcode', color: 'white' }}
                    title=" 健康码"
                    titleStyle={{ color: 'white', fontWeight: 'bold' }}
                    rightIcon={{ type: 'font-awesome', name: 'chevron-right', color: 'white', size: '20' }}
                    onPress={() => this.props.navigation.navigate('HealthCodeScreen', { username: this.state.name, token: this.state.token, })}
                />
                <ListItem
                    Component={TouchableScale}
                    friction={90}
                    ...
                    ViewComponent={LinearGradient} // Only if no expo
                    leftIcon={{ type: 'font-awesome', name: 'camera', color: 'white' }}
                    title=" 健康码扫描器"
                    titleStyle={{ color: 'white', fontWeight: 'bold' }}
                    rightIcon={{ type: 'font-awesome', name: 'chevron-right', color: 'white', size: '20' }}
                    onPress={() => this.props.navigation.navigate('ScannerScreen', { username: this.state.username, token: this.state.token, })}
                />
                <ListItem
                    Component={TouchableScale}
                    friction={90}
                    ...
                    ViewComponent={LinearGradient} // Only if no expo
                    leftIcon={{ type: 'entypo', name: 'clock', color: 'white' }}
                    title=" 打卡提醒"
                    titleStyle={{ color: 'white', fontWeight: 'bold' }}
                    rightIcon={{ type: 'font-awesome', name: 'chevron-right', color: 'white', size: '20' }}
